...
class DocModeratorController extends Controller
{
    ...
    public function contributedcabinetdecisionlist(Request $request, $val)
    {
    	if(Auth::user()->usertypes_id==4){
           if($val==1){
            ...
            ->select('documents.id','documents.documenttypes_id','documents.documentnumber','documents.filepath','documents.created_at','documents.entitle','documents.status','approver_status','moderator_status')
    ...
    public function contributedcabinetdecisionverify(Request $request, $id)
    {
        if($request->ajax())
        {
           ...
           $updated= Documentprocessing::where('documents_id',$id)->update($formdata);
            //dd($updated);
        }
    ...
    public function policylist(Request $request, $val)
    {
        ...
        $documenttype=Documenttype::all();
        return view('documentmoderator.policylist',compact('listdata','val','documenttype'));
    }
    public function policyverify(Request $request, $id)
    {
        if($request->ajax())
        {
