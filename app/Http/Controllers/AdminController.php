...
//                $number = $mobile;
    ...
    public function useredit(Request $request, $id)
    {
     ...
     return response()->json(['resultdata' => $resultdata,'department' => $department,'designation'=>$designation,'office'=>$office,'staffcategory'=>$staffcategory,'usertype'=>$usertype,'fielddepartment'=>$fielddepartment]);
