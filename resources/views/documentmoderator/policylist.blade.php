...
<div class="row ">
 ...
 <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Policy List</strong></p>
   </div>
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs">
                      ...
                      @if($documenttypes->id==$res->documenttypes_id)
                        ...
                        <a target="_blank" href="{{ asset('Policy').'/'.$res->filepath }}">View File</a>
                        @else
                      <img src="{{ asset('Policy').'/'.$res->filepath }}" class='img-thumbnail displaythumbnail customform eng_xxxs fg-darkCrimson' alt='Image' id='uploadedimage' width='150px'>
                      @endif
                      @endif
                      @endforeach
