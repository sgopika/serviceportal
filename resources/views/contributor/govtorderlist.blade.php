        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
           ...
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" id="godate" name="godate" min="10" maxlength="10" />
                <p id="godateerror" style="display:none; color:#FF0000;" >Only numbers /   are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
  ...
  /*go date */
            ...
            if(day < 10)
             ...
             $('#godate').attr('max', maxDate);
              ...
              $("#godate").inputmask("dd-mm-yyyy", {"placeholder": "dd-mm-yyyy", "yearrange":{minyear: 1957, maxyear: max_year },"defaultDate":maxDate});
