      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
           ...
           <div class="row customformrow">
            ...
            <!-- <div class="col-md-6 py-2">
                <input data-inputmask-alias="date" data-inputmask-inputformat="dd/mm/yyyy" im-insert="false" placeholder="dd/mm/yyyy" id="filedate" name="filedate" min="10" maxlength="10"  />
                <p id="filedateerror" style="display:none; color:#FF0000;" >Only A -Z a-z ,numbers / () .  are allowed.</p>
            </div>--><!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <input type="text" placeholder="dd/mm/yyyy" id="filedate" name="filedate" min="10" maxlength="10" />
                <p id="filedateerror" style="display:none; color:#FF0000;" >Only A -Z a-z ,numbers / () .  are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
