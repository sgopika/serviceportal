...
function addfaqs() {
    ...
    html +=
        '<td><input type="text" class="form-control" min="0" placeholder = "Name" ></td>';
    html +=
        '<td><select class="form-control customform"><option value = "0" > Default select </option><option value = "1" > Female </option> <option value = "2" > Male </option> <option value = "3" > Trans < /option> </select > </td > ';
    html +=
        '<td><select class="form-control customform"><option value="0">relationship</option></select></td>';
    html += '<td><input type="text"  class="form-control" > </td>';
    html += '<td><input type="text"  class="form-control"></td>';
    html +=
        '<td><select class="form-control customform" id=""><option value = "0" > Default select </option> <option value = "1" > Yes </option> <option value = "2" > No  </option></select></td > ';
    html += '<td class="mt-10"><button class="badge badge-danger" onclick="$(\'#faqs-row1' + faqs_row +
        '\').remove();"><i class="fa fa-trash"></i> Delete</button></td>';

    html += '</tr>';

    $('#geo_table tbody').append(html);
...
function addfaqs_property() {
    ...
    html += '<td><input type="text"  class="form-control" min="0" placeholder = "0" > </td>';
    html += '<td><input type="text"  class="form-control" min="0" placeholder="0"></td>';
    html +=
        '<td><input type="text" class="form-control" min="0" placeholder="0"></td>';
    html += '<td><input type="text"  class="form-control"  min="0" placeholder = "0" > </td>';
    html += '<td><input type="text" class="form-control"  min="0" placeholder="0"></td>';
    html += '<td><input type="text" class="form-control"  min="0" placeholder="0"></td>';
    html += '<td><input type="text" class="form-control" min="0" placeholder="0" readonly></td>';
...
$('#ownland').on('change ', function() {
    var ownland_opt = $("#ownland_opt").val();
    // alert(ownland_opt);
    if (ownland_opt == 1) {
        $('#property_table').show();
        $('#declaration').hide();
