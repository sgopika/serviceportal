	...
	<div class="col-12 py-2">
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb breadbar justify-content-end">
		    ...
		    <li class="breadcrumb-item eng_xxxs">Meter Reading</li>
		  </ol>
		</nav>
	</div> <!-- col12 -->
	<div class="col-12 py-1 px-2 ">
		<p class="eng_xxs px-3 fg-darkBrown"> KSEB Meter Reading</p>
	</div> <!-- ./col12 -->	
				...
				<div class="col-md-12">
					<table class="table">
						<thead class="thead-dark">
						  <tr>
							<th scope="col">Bill No/ Meter ID</th>
							<th scope="col">Bill Month</th>
							<th scope="col">Connection Status</th>
							<th scope="col">Tariff</th>
							<th scope="col">Connected phase/Load</th>
