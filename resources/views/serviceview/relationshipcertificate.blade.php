  ...
  <div class="col-12 py-2  ">
    <nav aria-label="breadcrumb ">
      <ol class="breadcrumb breadbar justify-content-end">
        ...
        <li class="breadcrumb-item eng_xxxs">Relationship Certificate</li>
      </ol>
    </nav>
  </div> <!-- col12 -->
  <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown"> <h2>Relationship Certificate </h2></p>
  </div> <!-- ./col12 --> 
  <div class="col-12 py-1 px-2 ">
...
<div class="tab-content col-12 py-1 px-2" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-application" role="tabpanel" aria-labelledby="pills-application-tab"> 
    ...
    <div class="row customformrow">
      <div class="col-md-3 py-2">
        <label for="IDNAME" class="eng_xxxs fg-darkBrown">Name<font class="text-danger eng_xxxxs"> * </font></label>
        
      </div> <!-- ./col-md-3 -->
      <div class="col-md-3 py-2">
         <input type="text" class="form-control" name="name" id="name" minlength="3" maxlength="99" required>
         <p id="nameerror" style="display:none; color:#FF0000;" >Only A -Z a-z Characters, dots and space are allowed.</p>
      </div> <!-- ./col-md-3 -->
      <div class="col-md-3 py-2">
        <label for="IDNAME" class="eng_xxxs fg-darkBrown">Address<font class="text-danger eng_xxxxs"> * </font></label>
        
      </div> <!-- ./col-md-3 -->
      <div class="col-md-3 py-2">
        <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="address" name="address" aria-describedby="HELPNAME2" required></textarea>
    ...
    <div class="row customformrow">
      <div class="col-md-12 py-2">
        <h4>Details Of Relatives Of Above Person</h4>
    ...
    <div class="row customformrow">
      <div class="col-md-12 py-2">
        <div class="table-responsive">  
            ...
            <tr>  
                <td><input type="text" name="addmore[0][nameofperson]" id="nameofperson0" placeholder="Enter Name" class="form-control nameofperson" /></td>  
                  
                <td><select class="form-control customform eng_xxxs fg-darkCrimson" name="addmore[0][gender]" id="gender0" aria-describedby="HELPNAME2">
           <option>Default select</option>
         </select></td>  
                <td><select class="form-control customform eng_xxxs fg-darkCrimson" name="addmore[0][relationship]" id="relationship0" aria-describedby="HELPNAME2">
           <option>Default select</option>
         </select></td>
                <td><input type="text" name="addmore[0][age]" id="age0" placeholder="Enter Age" class="form-control" minlength="1" maxlength="3" /></td>  
                <td><input type="text" name="addmore[0][occupation]" id="occupation0" placeholder="Enter Occupation" class="form-control" /></td>  
  ...
  <div class="tab-pane fade" id="pills-attachment" role="tabpanel" aria-labelledby="pills-attachment-tab">
    ...
    <div id="form_section2">
        ...
        <div class="row customformrow">
          <div class="col-md-6 py-2">
            <label for="IDNAME" class="eng_xxxs fg-darkBrown">Aadhar Card<font class="text-danger eng_xxxxs"> * </font></label>
            <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> additional information.</small>
          </div> <!-- ./col-md-6 -->
          <div class="col-md-6 py-2">
              <input type="file" class="form-control customform eng_xxxs fg-darkCrimson" id="aadharcard" name="aadharcard" aria-describedby="HELPNAME1" placeholder="Placeholder value" required="required">
               <p id="aadharcarderror" style="display:none; color:#FF0000;">Only PDF format allowed</p>
               <p id="aadharcarderror1" style="display:none; color:#FF0000;" class="mal_xxxs">Allowed size 100 KB.</p>
...
@include('serviceview.relationshipcertscript')
@endsection
