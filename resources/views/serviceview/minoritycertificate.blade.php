...
<div class="row ">
  ...
  <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown"> <h2>Minority Certificate </h2></p>
  </div> <!-- ./col12 --> 
<div class="col-12 py-1 px-2 ">
...
<div class="tab-content col-12 py-1 px-2" id="pills-tabContent">
  ...
  <div class="col-12 md-whiteframe-2dp">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        <label for="IDNAME2" class="eng_xxxs fg-darkBrown">Community</label>
        <small id="HELPNAME2" class="form-text eng_xxxxs text-muted"> additional information.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
           <select class="form-control customform eng_xxxs fg-darkCrimson" id="community" name="community" aria-describedby="community" required="required">
           <option>Default select</option>
         </select>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
        ...
        <div class="row customformrow">
      <div class="col-md-6 py-2">
        <label for="IDNAME" class="eng_xxxs fg-darkBrown">Proof of Caste/Community* </label>
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> additional information.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
          <input type="file" class="form-control customform eng_xxxs fg-darkCrimson" id="proof_caste" name="proof_caste" aria-describedby="HELPNAME1" placeholder="Placeholder value" required="required">
           <p id="proof_casteerror" style="display:none; color:#FF0000;">
                  Invalid File format. 
                  </p>
                  <p id="proof_casteerror1" style="display:none; color:#FF0000;" class="mal_xxxs">
                  Allowed size 100 KB.
                  </p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
...
@include('serviceview.minoritycertificatescript')
@endsection