                            ...
                            <div class="tab-pane fade show active" id="pills-application" role="tabpanel" aria-labelledby="pills-application-tab">
                                <div id="form_section">
                                    ...
                                    <div class="row customformrow">
                                        ...
                                        <div class="col-md-3 py-2">
                                            ...
                                            <select class="form-control customform eng_xxxs fg-darkCrimson" id="cerType" aria-describedby="HELPNAME2" required>
                                                ...
                                                <option value="1">Non-Re marriage certificate</option>
                                            </select>
                                    ...
                                    <div id="inter_cast_certificate_section">
                                        <center>
                                            <h5 class="card-header"> Non-Re Marriage Certificate</h5>
                                        </center>
                                        ...
                                        <div class="row customformrow">
                                            ...
                                            <div class="col-md-6 py-2">
                                                <label for="cerPurpose" class="eng_xxxs fg-darkBrown">Select One Category</label>
                                                <sup style="color:red">*</sup></label>
                                                <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> (Select
                                                    one Deceased/Deserted/Divorced )</small>
                                            </div>
                                            <div class="col-md-6 py-2">
                                                <select class="form-control customform eng_xxxs fg-darkCrimson" id="app_rel_category" aria-describedby="HELPNAME2" required>
                                                    <option value="">Select One</option>
                                                    <option value="1">Deceased</option>
                                                    <option value="2">Deserted</option>
                                    ...
                                    <table class="table table-responsive" id="income" class="">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Affidavit</td>
                                                <td><input type="file" id="affidavit_file"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><button id="affidavit_file_attach" class="btn btn-primary">Save</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
...
@include('serviceview.nonremarriagecertificate_script')
@endsection
