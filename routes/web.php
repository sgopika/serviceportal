...
Route::get('/login', 'PortalController@login')->name('login');
...
//service filter
Route::post('/getcategoryservice', 'PortalController@getcategoryservice')->name('getcategoryservice');
Route::post('/getdeptservice', 'PortalController@getdeptservice')->name('getdeptservice');
Route::post('/getlifeeventservice', 'PortalController@getlifeeventservice')->name('getlifeeventservice');
Route::post('/getkeywordservice', 'PortalController@getkeywordservice')->name('getkeywordservice');
Route::post('/alphabetsearch', 'PortalController@alphabetsearch')->name('alphabetsearch');
Route::get('/janparichaylogin', 'PortalController@janparichaylogin')->name('janparichaylogin');
//service filter

Route::get('/modalpop/{id}', 'PortalController@modalpop')->name('modalpop');
Route::get('/modalserviceview/{id}', 'PortalController@modalserviceview')->name('modalserviceview');
...
Route::get('logout', 'PortalController@logout')->name('logout');



/*Service Portal*/
Route::group(['middleware' => ['auth','App\Http\Middleware\Serviceportal']], function()
{
Route::get('/servicedash', 'ServiceController@servicedash')->name('servicedash')->middleware('auth');
Route::get('/castecertificate', 'ServiceController@castecertificate')->name('castecertificate')->middleware('auth');
Route::get('/migrationcertificate', 'ServiceController@migrationcertificate')->name('migrationcertificate')->middleware('auth');
Route::get('/duplicatecertificate', 'ServiceController@duplicatecertificate')->name('duplicatecertificate')->middleware('auth');
Route::get('/domicilecertificate', 'ServiceController@domicilecertificate')->name('domicilecertificate')->middleware('auth');
Route::get('/locationcertificate', 'ServiceController@locationcertificate')->name('locationcertificate')->middleware('auth');
Route::get('/relationshipcertificate', 'ServiceController@relationshipcertificate')->name('relationshipcertificate')->middleware('auth');
Route::get('/residencecertificate', 'ServiceController@residencecertificate')->name('residencecertificate')->middleware('auth');
Route::get('/marriagecertificate', 'ServiceController@marriagecertificate')->name('marriagecertificate')->middleware('auth');
Route::get('/minoritycertificate', 'ServiceController@minoritycertificate')->name('minoritycertificate')->middleware('auth');

/*pranav*/
Route::get('/ksebbilling', 'ServiceController@ksebbilling')->name('ksebbilling')->middleware('auth');
Route::get('/ksebbillinghistory', 'ServiceController@ksebbillinghistory')->name('ksebbillinghistory')->middleware('auth');
Route::get('/ksebconsumptionhistory', 'ServiceController@ksebconsumptionhistory')->name('ksebconsumptionhistory')->middleware('auth');
Route::get('/ksebmeterreading', 'ServiceController@ksebmeterreading')->name('ksebmeterreading')->middleware('auth');
Route::get('/ksebpaymentdetails', 'ServiceController@ksebpaymentdetails')->name('ksebpaymentdetails')->middleware('auth');
Route::get('/ksebtransactionhistory', 'ServiceController@ksebtransactionhistory')->name('ksebtransactionhistory')->middleware('auth');
Route::get('/ksebuserregistration', 'ServiceController@ksebuserregistration')->name('ksebuserregistration')->middleware('auth');
Route::get('/pensionersearch', 'ServiceController@pensionersearch')->name('pensionersearch')->middleware('auth');


/*Nawas*/
Route::get('/intercastemarriagecertificate', 'ServiceController@intercastemarriagecertificate')->name('intercastemarriagecertificate')->middleware('auth');
Route::get('/edist_onetimeregistration', 'ServiceController@edist_onetimeregistration')->name('edist_onetimeregistration')->middleware('auth');
Route::get('/indiraawasyojanaappln', 'ServiceController@indiraawasyojanaappln')->name('indiraawasyojanaappln')->middleware('auth');
Route::get('/nonremarriagecertificate', 'ServiceController@nonremarriagecertificate')->name('nonremarriagecertificate')->middleware('auth');
Route::get('/oneandsamecertificate', 'ServiceController@oneandsamecertificate')->name('oneandsamecertificate')->middleware('auth');
Route::get('/widowwidowercertificate', 'ServiceController@widowwidowercertificate')->name('widowwidowercertificate')->middleware('auth');


/*Shabeeba*/
Route::get('/equivalencycertificate', 'ServiceController@equivalencycertificate')->name('equivalencycertificate')->middleware('auth');
Route::get('/identificationcertificate', 'ServiceController@identificationcertificate')->name('identificationcertificate')->middleware('auth');
Route::get('/nativitycertificate', 'ServiceController@nativitycertificate')->name('nativitycertificate')->middleware('auth');
Route::get('/solvencycertificate', 'ServiceController@solvencycertificate')->name('solvencycertificate')->middleware('auth');
Route::get('/soochikacertificate', 'ServiceController@soochikacertificate')->name('soochikacertificate')->middleware('auth');



/*Kirshnapriya*/
Route::get('/birthcertificate', 'ServiceController@birthcertificate')->name('birthcertificate')->middleware('auth');
Route::get('/incomecertificate', 'ServiceController@incomecertificate')->name('incomecertificate')->middleware('auth');
Route::get('/destitutecertificate', 'ServiceController@destitutecertificate')->name('destitutecertificate')->middleware('auth');
Route::get('/nrega', 'ServiceController@nrega')->name('nrega')->middleware('auth');
Route::get('/landcertificate', 'ServiceController@landcertificate')->name('landcertificate')->middleware('auth');
Route::get('/possessionnoncertificate', 'ServiceController@possessionnoncertificate')->name('possessionnoncertificate')->middleware('auth');


/*Meera*/
Route::get('/communitycertificate', 'ServiceController@communitycertificate')->name('communitycertificate')->middleware('auth');
Route::get('/dependencycertificate', 'ServiceController@dependencycertificate')->name('dependencycertificate')->middleware('auth');
Route::get('/familymembershipcertificate', 'ServiceController@familymembershipcertificate')->name('familymembershipcertificate')->middleware('auth');
Route::get('/noncreamycertificate', 'ServiceController@noncreamycertificate')->name('noncreamycertificate')->middleware('auth');
Route::get('/valuationcertificate', 'ServiceController@valuationcertificate')->name('valuationcertificate')->middleware('auth');


/*Sabitha*/
Route::get('/lifecertificate', 'ServiceController@lifecertificate')->name('lifecertificate')->middleware('auth');
Route::get('/conversioncertificate', 'ServiceController@conversioncertificate')->name('conversioncertificate')->middleware('auth');
Route::get('/calicutuniversitychellan', 'ServiceController@calicutuniversitychellan')->name('calicutuniversitychellan')->middleware('auth');
Route::get('/deathcertificate', 'ServiceController@deathcertificate')->name('deathcertificate')->middleware('auth');
Route::get('/possessioncertificate', 'ServiceController@possessioncertificate')->name('possessioncertificate')->middleware('auth');
...
Route::post('/contributor/circularstore','DocumentController@circularstore')->name('contributor.circularstore')->middleware('auth');
	...
	/*rtidocument changed to policy*/
		...
		Route::get('/contributor/policylist', 'DocumentController@policylist')->name('contributor.policylist')->middleware('auth');
Route::get('contributor/policycreate','DocumentController@policycreate')->name('contributor.policycreate')->middleware('auth');
Route::post('/contributor/policystore','DocumentController@policystore')->name('contributor.policystore')->middleware('auth');
	Route::get('/contributor/policyedit/{id}', 'DocumentController@policyedit')->middleware('auth');
	Route::post('/contributor/policyupdate', 'DocumentController@policyupdate')->name('contributor.policyupdate')->middleware('auth');
	Route::get('/contributor/policydestroy/{id}', 'DocumentController@policydestroy')->middleware('auth');
	Route::get('/contributor/policystatus/{id}', 'DocumentController@policystatus')->middleware('auth');
